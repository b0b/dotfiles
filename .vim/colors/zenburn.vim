...
if exists("g:zenburn_high_Contrast")
    ...
    hi TabLineFill     guifg=#cfcfaf guibg=#353535 ctermfg=NONE ctermbg=238 cterm=NONE gui=bold
    hi TabLineSel      guifg=#efefef guibg=#3a3a39 ctermfg=NONE ctermbg=236 cterm=NONE gui=bold
    hi TabLine         guifg=#b6bf98 guibg=#353535 ctermfg=NONE ctermbg=238 cterm=NONE gui=bold
