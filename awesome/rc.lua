...
local tags = {}
tags.setup = {
    { name = "screen",  layout = layouts[1]  },
    { name = "web", layout = layouts[5]  },
...
for s = 1, screen.count() do
    ...
    mywibox[s].widgets = {
        ...
        spacer, datewidget,
        separator, batwidget,
        separator, pacmanwidget,
        separator, thermalwidget, spacer, tzswidget, spacer, cpuwidget,
        spacer,
...
for i = 1, keynumber do
    globalkeys = awful.util.table.join(globalkeys,
        awful.key({ modkey }, french_numkeys[i],
                  function ()
...
os.execute("/home/bob/docs/scripts/run_once.sh urxvtc -e screen &")
os.execute("/home/bob/docs/scripts/wall.sh &")
